...
mod tests {
    ...
    fn encode_decode() {
        ...
        let rlp_raw = crate::rlp::encode(&node);
        let decoded_node: MerkleNode = crate::rlp::decode(&rlp_raw).unwrap();
    ...
    fn decode_genesis_state() {
        ...
        let decoded_node: MerkleNode = crate::rlp::decode(&buffer).unwrap();
